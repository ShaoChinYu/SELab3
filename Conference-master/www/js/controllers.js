...
.controller('DashCtrl', function($scope,Important_People,Normal_People,Time,$http) {
  ...
  $scope.normal_people=[];
    ...
    $scope.requestMeeting=function(){
     ...
     // var max_day = 5;
      ...
      var url = "http://192.168.1.106:8080/meeting/arrangement/"
    ...
    $scope.getImportantPeople=function(i){
      ...
      var url = "http://192.168.1.106:8080/meeting/persons";
      $http.post(url)
        .success(function (data) {
  ...
  $scope.confirm = function(meeting){
    ...
    var url = "http://192.168.1.106:8080/meeting/confirm/"
...
.controller('ChatDetailCtrl', function($scope,$http) {
  ...
  function getMeetings(){
     ...
     */
    var url = "http://192.168.1.106:8080/meeting/show/"+view_person_id;
    $http.post(url)
      .success(function (data) {
